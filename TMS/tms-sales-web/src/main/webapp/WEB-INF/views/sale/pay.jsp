...
<div class="wrapper">
    ...
    <jsp:include page="../include/sider.jsp">
        <jsp:param name="menu" value="sales_pay"/>
    </jsp:include>
    <!-- =============================================== -->
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${salesPageInfo.list}" var="sale">
                            <tr >
                                ...
                                <td>
                                    <span class="btn btn-xs  ${sale.saleState=='未支付' ? 'btn-danger':'btn-success' }" >${sale.saleState}</span>
                                </td>
                                <td>
                                    <c:if test="${sale.saleState=='未支付'}">
                                    <a class="btn btn-primary btn-xs pay" rel="${sale.id}" value="${sale.salePrice}" href="javascript:;" title="缴费支付">缴费支付</a>
                                    </c:if>
                                </td>
    ...
    $(function(){
     ...
     $("#pagination").twbsPagination({
        ...
        $(".pay").click(function () {
            ...
            layer.confirm("需要支付"+price+"元,确定支付吗？", function (index) {
                layer.close(index);
                $.get("/sale/" + id + "/pay").done(function (result) {
