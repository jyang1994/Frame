            ...
            <div class="box">
                 <div class="box-body">
                     <form method="get" class="form-inline">
                         <input type="text" name="username" class="form-control" placeholder="联系人姓名" >
                        ...
                        <c:forEach items="${salesPageInfo.list}" var="sale">
                            <tr >
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary btn-xs"  href="/sale/ticket/${sale.saleTicketNum}/update"  title="挂失"><i class="fa fa-edit"></i> 详情</a>
